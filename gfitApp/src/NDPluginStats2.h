...
#define MAX_TIME_SERIES_TYPES TSGWidthY+1
...
#define NDPluginStatsCentroidThresholdHiString "CENTROID_THRESHOLD_HI"  /* (asynFloat64,      r/w) Threshold when computing centroids */
...
#define NDPluginStatsGAmplitudeXString        "GAMPLITUDEX_VALUE"   /* (asynFloat64,      r/o) Gaussian Amplitude X */
#define NDPluginStatsGAmplitudeYString        "GAMPLITUDEY_VALUE"   /* (asynFloat64,      r/o) Gaussian Amplitude Y */
#define NDPluginStatsGPositionXString         "GPOSITIONX_VALUE"    /* (asynFloat64,      r/o) X Gaussian */
#define NDPluginStatsGPositionYString         "GPOSITIONY_VALUE"    /* (asynFloat64,      r/o) Y Gaussian */
#define NDPluginStatsGWidthXString            "GWIDTHX_VALUE"       /* (asynFloat64,      r/o) Gaussian Width X */
#define NDPluginStatsGWidthYString            "GWIDTHY_VALUE"       /* (asynFloat64,      r/o) Gaussian Width Y */
...
#define NDPluginStatsTSGAmplitudeXString      "TS_GAMPLITUDEX_VALUE" /* (asynFloat64Array, r/o) Series of Gaussian Amplitude X */
#define NDPluginStatsTSGAmplitudeYString      "TS_GAMPLITUDEY_VALUE" /* (asynFloat64Array, r/o) Series of Gaussian Amplitude Y */
#define NDPluginStatsTSGPositionXString       "TS_GPOSITIONX_VALUE"  /* (asynFloat64Array, r/o) Series of X Gaussian */
#define NDPluginStatsTSGPositionYString       "TS_GPOSITIONY_VALUE"  /* (asynFloat64Array, r/o) Series of Y Gaussian */
#define NDPluginStatsTSGWidthXString          "TS_GWIDTHX_VALUE"     /* (asynFloat64Array, r/o) Series of Gaussian Width X */
#define NDPluginStatsTSGWidthYString          "TS_GWiDTHY_VALUE"     /* (asynFloat64Array, r/o) Series of Gaussian Width Y */
...
#define NDPluginStatsProfileGaussianXString   "PROFILE_GAUSSIAN_X"  /* (asynFloat64Array, r/o) X gaussian profile */
#define NDPluginStatsProfileGaussianYString   "PROFILE_GAUSSIAN_Y"  /* (asynFloat64Array, r/o) y gaussian profile */
...
/** Does image statistics.  These include
  ...
  * Histogram
  */
class NDPluginStats2 : public NDPluginDriver {
public:
    NDPluginStats2(const char *portName, int queueSize, int blockingCallbacks, 
...
protected:
    ...
    int NDPluginStatsCentroidThresholdHi;
    ...
    int NDPluginStatsGAmplitudeX;
    int NDPluginStatsGAmplitudeY;
    int NDPluginStatsGPositionX;
    int NDPluginStatsGPositionY;
    int NDPluginStatsGWidthX;
    int NDPluginStatsGWidthY;
    ...
    int NDPluginStatsTSGAmplitudeX;
    int NDPluginStatsTSGAmplitudeY;
    int NDPluginStatsTSGPositionX;
    int NDPluginStatsTSGPositionY;
    int NDPluginStatsTSGWidthX;
    int NDPluginStatsTSGWidthY;
    ...
    int NDPluginStatsProfileGaussianX;
    int NDPluginStatsProfileGaussianY;
